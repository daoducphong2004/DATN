    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav ">
                <li>
                    <a href="{{ route('home') }}" target="_blank"><i class="fas fa-home"></i><span class="hidden-md hidden-lg"> Cổng Light Novel</span></a>
                </li>
                <li>
                    ...
                    @else
                        <a href="#" style="color: red" onclick="alert('Bạn không có quyền truy cập tính năng này!')">Danh Sách Truyện</a>
                    @endif
                </li>
                <li>
                    ...
                    @else
                        <a href="#" style="color: #3107dc" onclick="alert('Bạn không có quyền truy cập tính năng này!')">User</a>
                    @endif
                    {{-- <a href="{{ route('user_index') }}" style="color: #3107dc">User</a> --}}
                </li>
                <li>
                    ...
                    @else
                        <a href="#" style="color: #e3953e" onclick="alert('Bạn không có quyền truy cập tính năng này!')">Thể Loại</a>
                    @endif
                </li>
                <li class="dropdown">
