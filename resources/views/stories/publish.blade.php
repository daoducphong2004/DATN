...
<div id="page-top"></div>
    ...
    <div id="navbar" class="headroom">
        ...
        <div class="page-top-group ">
                    ...
                    <div class="row d-block clearfix">
                        <div class="col-12 col-lg-3 float-right">
                            <form method="post" action="https://docln.net/xuat-ban">
                                <input type="hidden" name="_token" value="RoVR3vbYqJwRLPo31OeRWpuk5IYzEa1XubKSx458" autocomplete="off">                    <section class="sub-index-style js-tongtien">
                                ...
                                <section id="search-by-month" class="sub-index-style">
                                    ...
                                    <div class="submit-wrapper force-block">
                                        <input type="submit" class="button inline-block filter-submit button-primary-green" value="Áp dụng">
                                    </div>
                                </section>
                                <section class="sub-index-style">
                                    <div class="section-content">
                                        ...
                                        <div class="keywords-bar clear">
                                            <input class="search-form in" type="text" placeholder="Tối thiểu 2 kí tự" name="keywords" value=""> 
                                            <input id="search-go" class="search-go_form search-form submit " type="submit" value="Tìm">						
                                        </div>
                                    </div>
                                </section>
                                <div class="list-filters none force-block-l">
                                    <section class="sub-index-style">
                                        ...
                                        <div class="section-content">
                                            <ul class="filter-type unstyled">
                                                                                <li>
                                                    <input name="nph[]" id="ipm" value="ipm" type="checkbox"><label for="ipm"> IPM</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="thaiha" value="thaiha" type="checkbox"><label for="thaiha"> Thái Hà Books</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="quangvan" value="quangvan" type="checkbox"><label for="quangvan"> Quảng Văn</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="amak" value="amak" type="checkbox"><label for="amak"> Amak</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="sky" value="sky" type="checkbox"><label for="sky"> Sky Light Novel</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="tsuki" value="tsuki" type="checkbox"><label for="tsuki"> Tsuki Light Novel</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="nhanam" value="nhanam" type="checkbox"><label for="nhanam"> Nhã Nam</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="owlbooks" value="owlbooks" type="checkbox"><label for="owlbooks"> Owlbooks</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="kimdong" value="kimdong" type="checkbox"><label for="kimdong"> Kim Đồng</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="tre" value="tre" type="checkbox"><label for="tre"> Trẻ</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="tabooks" value="tabooks" type="checkbox"><label for="tabooks"> TA Books</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="uranix" value="uranix" type="checkbox"><label for="uranix"> Uranix</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="ai" value="ai" type="checkbox"><label for="ai"> Ai Novel</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="shine" value="shine" type="checkbox"><label for="shine"> Shine Novel</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="usagi" value="usagi" type="checkbox"><label for="usagi"> Usagi Light Novel</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="ichi" value="ichi" type="checkbox"><label for="ichi"> Ichi Light Novel</label>
                                                </li>
                                                                                <li>
                                                    <input name="nph[]" id="orionbooks" value="orionbooks" type="checkbox"><label for="orionbooks"> Orion Books</label>
                                                </li>
                                                                            </ul>
                                        </div>
                                            ...
                                            <div class="select-wrapper">
                                                <select name="truyen" style="width: 100%;">
                                                    <option value="0">Chọn tựa</option>
                                                            ...
                                                            Naze ka Uchi no Mise ga Isekai ni Teni shitan desu kedo Dare ka Setsumei Onegaishimasu?
                                                        </option>
                                                            ...
                                                            Uchi no Musume no Tame Naraba, Ore Moshikashitara Maou mo Taoserukamo Shirenai.
                                                        </option>
                                    ...
                                    <section class="sub-index-style">
                                        ...
                                        <div class="section-content">
                                            <ul class="filter-type unstyled">
                                                                                                                    <li>
                                                    <input name="cuahang[]" id="tiki" value="tiki" type="checkbox"><label for="tiki"> Tiki</label>
                                                </li>
                                                                                                                                                        <li>
                                                    <input name="cuahang[]" id="fahasa" value="fahasa" type="checkbox"><label for="fahasa"> Fahasa</label>
                                                </li>
                                                                                                                                                        <li>
                                                    <input name="cuahang[]" id="shopee" value="shopee" type="checkbox"><label for="shopee"> Shopee</label>
                                                </li>
                                                                                                                                                        <li>
                                                    <input name="cuahang[]" id="shopee_aff" value="shopee_aff" type="checkbox"><label for="shopee_aff"> Shopee</label>
                                                </li>
                                                                                                                                                        <li>
                                                    <input name="cuahang[]" id="hikaru" value="hikaru" type="checkbox"><label for="hikaru"> Hikaru</label>
                                                </li>
                                                                                                                                                        <li>
                                                    <input name="cuahang[]" id="pibook" value="pibook" type="checkbox"><label for="pibook"> Pibook</label>
                                                </li>
                                                                                                                                                        <li>
                                                    <input name="cuahang[]" id="lazada" value="lazada" type="checkbox"><label for="lazada"> Lazada</label>
                                                </li>
                                                                                                                </ul>
                                        </div>
                                        <div class="submit-wrapper">
                                    ...
                                    <section class="sub-index-style">
                                        ...
                                        <div class="section-content">
                                            <ul class="filter-type unstyled">
                                                <li>
                                                    <input name="docthu" type="checkbox" id="docthu" value="1" ><label for="docthu">Đọc thử</label>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="submit-wrapper">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <div class="listall-detail">
                                                        <h3 class="series-title text-xl font-bold">
                                                                                                            <a class="series-name" href="xuat-ban/852-hanh-trinh-cua-elaina-tap-15.html">Hành Trình Của Elaina - Tập 15</a>
                                                            ...
                                                            <main class="sect-body none force-block-l">
                                                                <div class="info-list long-text row m-0">
                                                                    <div class="info-item col-12 col-md-6">
                                                                        ...
                                                                        <span class="info-value"><a href="xuat-banbb56.html?tacgia=Shiraishi%20Jougi">Shiraishi Jougi</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Họa sĩ:</span> 
                                                                        <span class="info-value"><a href="xuat-ban692f.html?hoasi=Azure">Azure</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                    ...
                                                                    <div class="info-item col-12 col-md-6">
                                                                        ...
                                                                        <span class="info-value">125.000đ</span>
                                                                                                    ...
                                                                                                    <div class="series-summary">Ngày xửa ngày xưa, có một cô phù thủy tên Elaina.
            ...
            Tổng hợp 43 mẩu truyện, bao gồm các ngoại truyện chỉ có trong bản đặc biệt hoặc sự kiện theo mùa, cùng...</div>
                                                                                                    
                                                        <div class="store-list">
                                                                                                                                                        <a class="button store-link" style="background-color: #ff5520" href="https://shopee.vn/Sách-Hành-Trình-Của-Elaina-Tập-15-i.40470612.28907112532" rel="nofollow" target="_blank">Shopee</a>
                                                                                                                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <div class="listall-detail">
                                                        <h3 class="series-title text-xl font-bold">
                                                                                                            <a class="series-name" href="xuat-ban/850-ma-phap-thieu-nu-tap-8.html">Ma Pháp Thiếu Nữ - Tập 8</a>
                                                            <span class="publisher-name">
                                                                <a href="xuat-ban0cd7.html?nph=usagi">Usagi Light Novel</a> phát hành 
                                                            </span>
                                                        </h3>
                                                        ...
                                                        <section class="mobile-view mobile-toggle">
                                                            ...
                                                            <main class="sect-body none force-block-l">
                                                                <div class="info-list long-text row m-0">
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Tác giả:</span> 
                                                                        <span class="info-value"><a href="xuat-banf9a0.html?tacgia=Endou%20Asari">Endou Asari</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Họa sĩ:</span> 
                                                                        <span class="info-value"><a href="xuat-banbd70.html?hoasi=Marui-no">Marui-no</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Dịch giả:</span> 
                                                                        <span class="info-value">
                                                                    ...
                                                                    <div class="info-item col-12 col-md-6">
                                                                        ...
                                                                        <span class="info-value">159.000đ</span>
                                                                                                    ...
                                                                                                    <div class="series-summary">Những trận chiến phép thuật giữa các Ma pháp thiếu nữ đang ngày càng trở nên thú vị hơn.
            Snow White vẫn tiếp tục hoạt động với tư cách thợ săn ma pháp thiếu nữ, cô hiện giờ giống như ngọc đang trong quá trình mài giũa.
            Trong quá trình tìm kiếm tung tích của Ripple, cô nhận được cuộc gọi từ một trong...</div>
                                                                                                    
                                                        <div class="store-list">
                                                                                                                                                        <a class="button store-link" style="background-color: #c92127" href="https://www.fahasa.com/ma-phap-thieu-nu-tap-8-ban-dac-biet-tang-kem-bookmark-nhan-vat-postcard-pin-cai-ma-phap-thieu-nu.html?fhs_campaign=CATEGORY" rel="nofollow" target="_blank">Fahasa</a>
                                                                                                                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <div class="listall-detail">
                                                        <h3 class="series-title text-xl font-bold">
                                                                                                            <a class="series-name" href="xuat-ban/851-to-se-tru-mua-cung-cau.html">Tớ Sẽ Trú Mưa Cùng Cậu</a>
                                                            <span class="publisher-name">
                                                        ...
                                                        <section class="mobile-view mobile-toggle">
                                                            ...
                                                            <main class="sect-body none force-block-l">
                                                                <div class="info-list long-text row m-0">
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Tác giả:</span> 
                                                                        <span class="info-value"><a href="xuat-banbb0e.html?tacgia=Sushi%20Thunder">Sushi Thunder</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Họa sĩ:</span> 
                                                                        <span class="info-value"><a href="xuat-bane3fb.html?hoasi=Sogawa">Sogawa</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Dịch giả:</span> 
                                                                        <span class="info-value">
                                                                                                                                                <a href="xuat-ban6eba.html?dichgia=Satoukibi">Satoukibi</a>
                                                                                                                                        </span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Số trang:</span> 
                                                                    ...
                                                                    <div class="info-item col-12 col-md-6">
                                                                        ...
                                                                        <span class="info-value">179.000đ</span>
                                                                                                    ...
                                                                                                    <div class="series-summary">Vì những sai lầm của bản thân ở trường cấp hai, cùng với vẻ ngoài nhìn như côn đồ nên khi lên cấp ba, Aoki Teru không được bạn bè đón nhận. Dù là ở bất kỳ đâu, cậu đều không tìm được một nơi chốn dành cho mình.
            Một ngày, cậu tình cờ gặp được Amamori Kokoro, đàn chị học trên cậu một khóa đang ngồi tr...</div>
                                                                                                    
                                                        <div class="store-list">
                                                                                                                                                        <a class="button store-link" style="background-color: #c92127" href="https://www.fahasa.com/to-se-tru-mua-cung-cau-ban-dac-biet-tang-kem-1-bookmark-2-photocard-bo-goc.html?fhs_campaign=CATEGORY" rel="nofollow" target="_blank">Fahasa</a>
                                                                                                                                                                                                        <a class="button store-link" style="background-color: #f78320" href="https://www.hikaru.vn/products/to-se-tru-mua-cung-cau" rel="nofollow" target="_blank">Hikaru</a>
                                                                                                                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <div class="listall-detail">
                                                        <h3 class="series-title text-xl font-bold">
                                                                                                            <a class="series-name" href="xuat-ban/843-co-nang-shimotsuki-trot-phai-long-nhan-vat-nen-tap-4.html">Cô Nàng Shimotsuki Trót Phải Lòng Nhân Vật Nền - Tập 4</a>
                                                            <span class="publisher-name">
                                                        ...
                                                        <section class="mobile-view mobile-toggle">
                                                            ...
                                                            <main class="sect-body none force-block-l">
                                                                <div class="info-list long-text row m-0">
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Tác giả:</span> 
                                                                        <span class="info-value"><a href="xuat-ban4fa7.html?tacgia=Yagami%20Kagami">Yagami Kagami</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Họa sĩ:</span> 
                                                                        <span class="info-value"><a href="xuat-ban1799.html?hoasi=Roha">Roha</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Dịch giả:</span> 
                                                                        <span class="info-value">
            ...
            Vào học kì 3, có một học sinh chuyển trường mới xuất hiện. Cô gái với mái tóc hồng và vẻ mặt khó chịu ấy tên là Kurumizawa Kururi. Hóa ra cô chính là “người bạn từng thân thiết thuở nhỏ của Koutarou mà cậu cứ nghĩ là con trai”! Nghi ngờ về “mối quan hệ mập mờ” của Koutarou và...</div>
                                                                                                    
                                                        <div class="store-list">
                                                                                                                                                        <a class="button store-link" style="background-color: #c92127" href="https://www.fahasa.com/co-nang-shimotsuki-trot-phai-long-nhan-vat-nen-tap-4-ban-gioi-han-tang-kem-bookmark-khung-anh-bia-ao-limited.html?fhs_campaign=CATEGORY" rel="nofollow" target="_blank">Fahasa</a>
                                                                                                                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <div class="listall-detail">
                                                        <h3 class="series-title text-xl font-bold">
                                                                                                            <a class="series-name" href="xuat-ban/844-ve-chuyen-toi-chuyen-sinh-thanh-slime-tap-4.html">Về Chuyện Tôi Chuyển Sinh Thành Slime - Tập 4</a>
                                                            <span class="publisher-name">
                                                                <a href="xuat-bande1b.html?nph=sky">Sky Light Novel</a> phát hành 
                                                            </span>
                                                        </h3>
                                                        ...
                                                        <section class="mobile-view mobile-toggle">
                                                            ...
                                                            <main class="sect-body none force-block-l">
                                                                <div class="info-list long-text row m-0">
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Tác giả:</span> 
                                                                        <span class="info-value"><a href="xuat-banadb9.html?tacgia=Fuse">Fuse</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Họa sĩ:</span> 
                                                                        <span class="info-value"><a href="xuat-ban10e8.html?hoasi=Mitz%20Vah">Mitz Vah</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Dịch giả:</span> 
                                                                        <span class="info-value">
                                                                                                                                                <a href="xuat-ban49e7.html?dichgia=Th%C3%B9y%20Linh">Thùy Linh</a>
                                                                                                                                        </span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Số trang:</span> 
                                                                    ...
                                                                    <div class="info-item col-12 col-md-6">
                                                                        ...
                                                                        <span class="info-value">175.000đ</span>
                                                                                                    ...
                                                                                                    <div class="series-summary">Đã vài tháng đã trôi qua kể từ lúc Milim rời đi, Liên minh Jura Tempest trải qua chuỗi ngày êm đềm và yên ả cứ thế tiếp nối ngày này sang tháng nọ. Giữa lúc ấy, sứ giả do Ma vương kiêm Thú vương Carrion phái đến đã xuất hiện.
            “Mỗi bên hãy phái cử đoàn sứ giả để xác định xem liệu việc tạo dựng quan h...</div>
                                                                                                    
                                                        <div class="store-list">
                                                                                                                                                        <a class="button store-link" style="background-color: #c92127" href="https://www.fahasa.com/ve-chuyen-toi-chuyen-sinh-thanh-slime-tap-4-tang-kem-bookmark-postcard.html" rel="nofollow" target="_blank">Fahasa</a>
                                                                                                                                                                                                        <a class="button store-link" style="background-color: #f78320" href="https://www.hikaru.vn/products/ve-chuyen-toi-chuyen-sinh-thanh-slime-tap-4" rel="nofollow" target="_blank">Hikaru</a>
                                                                                                                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <div class="listall-detail">
                                                        <h3 class="series-title text-xl font-bold">
                                                                                                            <a class="series-name" href="xuat-ban/842-riviere-va-dat-nuoc-cua-loi-cau-nguyen-tap-1.html">Riviere Và Đất Nước Của Lời Cầu Nguyện - Tập 1</a>
                                                            <span class="publisher-name">
                                                                <a href="xuat-ban2cc8.html?nph=amak">Amak</a> phát hành 
                                                            </span>
                                                        </h3>
                                                            ...
                                                            <main class="sect-body none force-block-l">
                                                                <div class="info-list long-text row m-0">
                                                                    ...
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Dịch giả:</span> 
                                                                        <span class="info-value">
                                                                                                                                                <a href="xuat-banff36.html?dichgia=Beast666">Beast666</a>
                                                                                                                                        </span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Số trang:</span> 
                                                                    ...
                                                                    <div class="info-item col-12 col-md-6">
                                                                        ...
                                                                        <span class="info-value">139.000đ</span>
                                                                                                    ...
                                                                                                    <div class="series-summary">Ở quốc đảo Kururunervia - Đất nước của Lời cầu nguyện, khi đang đau khổ vì không tìm được việc làm, McMillia đã vô tình gặp Riviere - bà chủ tiệm đồ cổ Riviere, với năng lực hóa giải lời nguyền trên những Nguyện vật mang sức mạnh kỳ lạ. Sau khi được mời vào làm trợ thủ tại tiệm, hai người cùng nhau...</div>
                                                                                                    
                                                        <div class="store-list">
                                                                                                                                                        <a class="button store-link" style="background-color: #c92127" href="https://www.fahasa.com/riviere-va-dat-nuoc-cua-loi-cau-nguyen-tap-1-riviere-and-the-nation-of-the-prayer-tang-kem-1-bookmark-1-postcard-hai-mat-3-card-bo-goc-nhu-ngoc-trai-1-photostrip.html?fhs_campaign=CATEGORY" rel="nofollow" target="_blank">Fahasa</a>
                                                                                                                                                                                                        <a class="button store-link" style="background-color: #f78320" href="https://www.hikaru.vn/products/riviere-va-dat-nuoc-cua-loi-cau-nguyen-tap-1-riviere-and-the-nation-of-the-prayer-ngoai-truyen-cua-elaina" rel="nofollow" target="_blank">Hikaru</a>
                                                                                                                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <div class="listall-detail">
                                                        <h3 class="series-title text-xl font-bold">
                                                                                                            <a class="series-name" href="xuat-ban/841-date-a-live-tap-15.html">Date A Live - Tập 15</a>
                                                            <span class="publisher-name">
                                                                <a href="xuat-ban2cc8.html?nph=amak">Amak</a> phát hành 
                                                            </span>
                                                        </h3>
                                                        ...
                                                        <section class="mobile-view mobile-toggle">
                                                            ...
                                                            <main class="sect-body none force-block-l">
                                                                <div class="info-list long-text row m-0">
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Tác giả:</span> 
                                                                        <span class="info-value"><a href="xuat-ban7860.html?tacgia=Tachibana%20Koushi">Tachibana Koushi</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Họa sĩ:</span> 
                                                                        <span class="info-value"><a href="xuat-ban1408.html?hoasi=Tsunako">Tsunako</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Dịch giả:</span> 
                                                                        <span class="info-value">
                                                                                                                                                <a href="xuat-ban4dba.html?dichgia=T%C3%A0i%20Th%E1%BB%8Bnh">Tài Thịnh</a>
                                                                                                                                        </span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Số trang:</span> 
                                                                    ...
                                                                    <div class="info-item col-12 col-md-6">
                                                                        ...
                                                                        <span class="info-value">128.000đ</span>
                                                                                                    ...
                                                                                                    <div class="series-summary">Hoshimiya Mukuro, Tinh linh trôi nổi trên không gian vũ trụ bao la đã đóng kín trái tim của chính mình bằng sức mạnh của Thiên thần. Itsuka Shidou sau mọi nỗ lực muốn giúp đỡ đã bị cự tuyệt hoàn toàn, cậu đã vứt bỏ do dự mà leo lên cỗ “Fraxinus” thế hệ mới, cùng với sự giúp sức của các Tinh linh khá...</div>
                                                                                                    
                                                        <div class="store-list">
                                                                                                                                                        <a class="button store-link" style="background-color: #c92127" href="https://www.fahasa.com/date-a-live-tap-15-mukuro-family-tang-kem-2-bookmark-1-set-card-doi.html?fhs_campaign=CATEGORY" rel="nofollow" target="_blank">Fahasa</a>
                                                                                                                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <div class="listall-detail">
                                                        <h3 class="series-title text-xl font-bold">
                                                                                                            <a class="series-name" href="xuat-ban/840-hoi-chung-tuoi-thanh-xuan-tap-10.html">Hội Chứng Tuổi Thanh Xuân - Tập 10</a>
                                                            <span class="publisher-name">
                                                                <a href="xuat-ban7417.html?nph=kimdong">Kim Đồng</a> phát hành 
                                                            </span>
                                                        </h3>
                                                        ...
                                                        <section class="mobile-view mobile-toggle">
                                                            ...
                                                            <main class="sect-body none force-block-l">
                                                                <div class="info-list long-text row m-0">
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Tác giả:</span> 
                                                                        <span class="info-value"><a href="xuat-bane21e.html?tacgia=Kamoshida%20Hajime">Kamoshida Hajime</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Họa sĩ:</span> 
                                                                        <span class="info-value"><a href="xuat-ban2cb5.html?hoasi=Mizoguchi%20Keeji">Mizoguchi Keeji</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Dịch giả:</span> 
                                                                        <span class="info-value">
                                                                    ...
                                                                    <div class="info-item col-12 col-md-6">
                                                                        ...
                                                                        <span class="info-value">105.000đ</span>
                                                                                                    ...
                                                                                                    <div class="series-summary">Những năm tháng cấp ba không thể nào quên rồi cũng kết thúc, Sakuta và các bạn trở thành sinh viên đại học. Không lâu sau đó, vào một ngày đầu thu, khi cậu đang trải qua những ngày tháng êm đềm… “Ban nãy là Uzuki thật hả?”
            Biểu hiện của trưởng nhóm thần tượng “Sweet Bullet” Uzuki có gì đó hơi kì quặ...</div>
                                                                                                    
                                                        <div class="store-list">
                                                                                                                                                        <a class="button store-link" style="background-color: #c92127" href="https://www.fahasa.com/hoi-chung-tuoi-thanh-xuan-tap-10-ban-gioi-han-tang-kem-standee-ivory-camera-card.html?fhs_campaign=CATEGORY" rel="nofollow" target="_blank">Fahasa</a>
                                                                                                                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <div class="listall-detail">
                                                        <h3 class="series-title text-xl font-bold">
                                                                                                            <a class="series-name" href="xuat-ban/839-pha-dao-di-gioi-cung-nu-than-khong-tin-do-tap-3-cong-chua-bang-tac-mau-lanh.html">Phá Đảo Dị Giới Cùng Nữ Thần Không Tín Đồ - Tập 3: Công Chúa Băng Tạc Máu Lạnh</a>
                                                            <span class="publisher-name">
                                                                <a href="xuat-ban7480.html?nph=orionbooks">Orion Books</a> phát hành 
                                                            </span>
                                                        </h3>
                                                        ...
                                                        <section class="mobile-view mobile-toggle">
                                                            ...
                                                            <main class="sect-body none force-block-l">
                                                                <div class="info-list long-text row m-0">
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Tác giả:</span> 
                                                                        <span class="info-value"><a href="xuat-ban22f2.html?tacgia=Oosaki%20Airu">Oosaki Airu</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Họa sĩ:</span> 
                                                                        <span class="info-value"><a href="xuat-ban3122.html?hoasi=Tam-U">Tam-U</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Dịch giả:</span> 
                                                                        <span class="info-value">
                                                                                                                                                <a href="xuat-ban0780.html?dichgia=Th%C3%BAy%20L%C6%B0%C6%A1ng">Thúy Lương</a>
                                                                                                                                        </span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Số trang:</span> 
                                                                    ...
                                                                    <div class="info-item col-12 col-md-6">
                                                                        ...
                                                                        <span class="info-value">100.000đ</span>
                                                                                                    ...
                                                                                                    <div class="series-summary">Sau khi chuyển sinh đến một thế giới khác, Makoto Takatsuki, một người chơi RPG lão luyện, đã dành thời gian của mình để tập luyện và nâng cấp kỹ năng. Gần một năm đã trôi qua kể từ khi Makoto trở thành một nhà thám hiểm, và cuối cùng cậu đã đạt cấp độ 20 và xếp hạng Sắt. Đây vốn là một chuyện đáng...</div>
                                                                                                    
                                                        <div class="store-list">
                                                                                                                                                        <a class="button store-link" style="background-color: #c92127" href="https://www.fahasa.com/pha-dao-di-gioi-cung-nu-than-khong-tin-do-tap-3-cong-chua-bang-tac-mau-lanh-tang-kem-bookmark-poster-a3.html?fhs_campaign=CATEGORY" rel="nofollow" target="_blank">Fahasa</a>
                                                                                                                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <div class="listall-detail">
                                                        <h3 class="series-title text-xl font-bold">
                                                                                                            <a class="series-name" href="xuat-ban/848-doi-anh-trong-mua-xuan-ngay-hom-qua.html">Đợi Anh Trong Mùa Xuân Ngày Hôm Qua</a>
                                                            <span class="publisher-name">
                                                                <a href="xuat-ban15d4.html?nph=thaiha">Thái Hà Books</a> phát hành 
                                                            </span>
                                                        </h3>
                                                        ...
                                                        <section class="mobile-view mobile-toggle">
                                                            ...
                                                            <main class="sect-body none force-block-l">
                                                                <div class="info-list long-text row m-0">
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Tác giả:</span> 
                                                                        <span class="info-value"><a href="xuat-ban9424.html?tacgia=Hachimoku%20Mei">Hachimoku Mei</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Họa sĩ:</span> 
                                                                        <span class="info-value"><a href="xuat-ban9263.html?hoasi=Kukka">Kukka</a></span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Dịch giả:</span> 
                                                                        <span class="info-value">
                                                                                                                                                <a href="xuat-ban1933.html?dichgia=Nguy%E1%BB%85n%20Th%E1%BB%8B%20Thu%20H%E1%BA%B1ng">Nguyễn Thị Thu Hằng</a>
                                                                                                                                        </span>
                                                                    </div>
                                                                    <div class="info-item col-12 col-md-6">
                                                                        <span class="info-name">Số trang:</span> 
                                                                    ...
                                                                    <div class="info-item col-12 col-md-6">
                                                                        ...
                                                                        <span class="info-value">119.000đ</span>
                                                                                                    ...
                                                                                                    <div class="series-summary">Khi tiếng loa lúc 6h chiều vang lên bài Greensleeves, ý thức của Kanae thực hiện bước nhảy thời gian.
            Funami Kanae, người bỏ nhà ra đi từ Tokyo đến hòn đảo Sodeshima xa xôi nơi cậu từng sống, bị cuốn vào một hiện tượng gọi là “Rollback” đưa cậu ngược dòng về quá khứ. Giữa khoảng thời gian hỗn loạn n...</div>
                                                                                                    
                                                        <div class="store-list">
                                                                                                                                                        <a class="button store-link" style="background-color: #c92127" href="https://www.fahasa.com/doi-anh-trong-mua-xuan-ngay-hom-qua-tang-kem-postcard.html?fhs_campaign=CATEGORY" rel="nofollow" target="_blank">Fahasa</a>
                                                                                                                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="pagination_wrap">
                        ...
                        <a href="xuat-ban2679.html?page=1" class="paging_item paging_prevnext prev  disabled ">Đầu</a>
                        ...
                        <a href="xuat-ban2bc9.html?page=86" class="paging_item paging_prevnext next ">Cuối</a>
                    </div>
                </div>
                                                            </section>
