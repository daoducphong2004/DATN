...
@section('content')
    <div class="container">
        <h2>Tình trạng truyện</h2>
        <div class="tabs">
            <div class="tab-header">
                <button class="tab-link active" onclick="openTab(event, 'reference')">Truyện Của Tôi</button>
                <button class="tab-link" onclick="openTab(event, 'other')">Truyện Tham Gia</button>
            </div>
                        ...
                        @foreach ($mybooks as $item)
                            <div class="thumb-item-flow col-4 col-md-3 col-lg-2">
                                <div class="thumb-wrapper ln-tooltip" data-tooltip-content="#series_{{ $item->id }}">
                                    ...
                                    <a href="{{ route('author.chapter.status', $item->slug) }}"
