            ...
            <tbody>
                @foreach ($contracts as $contract)
                    <tr>
                        ...
                        <td><img src="{{ asset(Storage::url($contract->contract_image)) }}" style="max-width: 200px;"
                                alt="{{ $contract->contract_code }}"></td>
                        ...
                        <tbody>
                            @foreach ($contracts as $contract)
                                <tr>
                                    ...
                                    <td>{{ $contract->user->username }}</td>
                                    <td>{{ $contract->start_date }}</td>
                                    <td><img src="{{ asset(Storage::url($contract->contract_image)) }}"
                                            style="max-width: 200px;" alt="{{ $contract->contract_code }}"></td>
                                    <td>{{ $contract->end_date }}</td>
                                    <td>{{ $contract->status }}</td>
