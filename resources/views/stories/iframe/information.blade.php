...
<form role="form" method="POST" action="https://docln.net/action/series/update">
	<input type="hidden" name="_token" value="1s68PBJKsMIU4nn1Wn9P2EbTNQaf2eWqi4pV2RqT">
	<input type="hidden" name="series_id" value="19025">

	<div class="form-group clearfix required">
		<label class="col-md-2 control-label pt-7 text-right">Tiêu đề</label>
		<div class="col-md-8">
			<input type="text" class="form-control" name="title" value="tesst 123">
		</div>
	</div>
	...
	<div class="form-group clearfix">
		...
		<div class="col-md-8">
			<input type="text" placeholder="Ngăn cách nhiều tên bằng dấu chấm phẩy ;" class="form-control" name="altname" value="">
		</div>
	</div>
	...
	<div class="form-group clearfix required">
		...
		<div class="col-md-8">
			<input type="text" class="form-control" name="author" value="hakizuki">
		</div>
	</div>
