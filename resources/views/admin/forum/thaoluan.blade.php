                ...
                <tbody>
                    @foreach ($data_forums as $item_forums)
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-link btn-sm view-comment" data-title="{{ $item_forums->title }}"
                            ...
                            <td>
                                ...
                                <form method="post" action="{{ route('deleteforum', $item_forums->id) }}"
