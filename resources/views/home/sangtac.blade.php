...
@section('content')
    ...
    <main id="mainpart" class="orinovel-page orinovel-type" style="min-height: 233px;">
                    ...
                    <div class="daily-recent_views mb-5">
                        ...
                        <div class="tns-outer" id="tns1-ow">
                            ...
                            <div id="tns1-mw" class="tns-ovh">
                                <div class="tns-inner" id="tns1-iw">
                                    <main class="row">
                                            ...
                                            <div class="thumb-wrapper">
                                                ...
                                                <div class="thumb-detail">
                                                    <div class="thumb_attr series-title"
                                                        title="Tôi Bị Cô Gái Yandere Ẩn Mình Trong Ngục Tối Giết Chết Vô Số Lần.">
                                                        <a href=""
                                                            class="link-underline link-underline-opacity-0 text-white">Tôi
                                                            Bị Cô Gái Yandere Ẩn Mình Trong Ngục Tối Giết Chết Vô Số
                                                            Lần.</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="thumb-wrapper">
                                                ...
                                                <div class="thumb-detail">
                                                    <div class="thumb_attr series-title"
                                                        title="Con quỷ trong cô bạn gái sa ngã của tôi sẽ chẳng bao giờ dừng lại">
                                                        <a href=""
                                                            class="link-underline link-underline-opacity-0 text-white">Con
                                                            quỷ trong cô bạn gái sa ngã của tôi sẽ chẳng bao giờ dừng
                                                            lại</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="thumb-wrapper">
                                                ...
                                                <div class="thumb-detail">
                                                    <div class="thumb_attr series-title"
                                                        title="Takane-san, chẳng phải là thích cậu rồi sao">
                                                        <a href=""
                                                            class="link-underline link-underline-opacity-0 text-white">Takane-san,chẳng
                                                            phải là thích cậu rồi sao</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="thumb-item-flow col-2 col-md-5 col-lg-3 type-original " id="tns1-item4"
                                            ...
                                            <div class="thumb-wrapper">
                                                ...
                                                <div class="thumb-detail">
                                                    <div class="thumb_attr series-title"
                                                        title="Hình như có một cô gái lạ mặt đang làm nội trợ trong nhà tôi. Nhưng vì cô nàng dễ thương nên tôi mặc kệ vậy">
                                                        <a href=""
                                                            class="link-underline link-underline-opacity-0 text-white">Hình
                                                            như có một cô gái lạ mặt đang làm nội trợ trong nhà tôi. Nhưng
                                                            vì cô
                                        ...
                                        <div class="thumb-item-flow col-2 col-md-5 col-lg-3 type-original " id="tns1-item5"
                                            aria-hidden="true" tabindex="-1">
                                            <div class="thumb-wrapper">
                                                ...
                                                <div class="thumb-detail">
                                                    <div class="thumb_attr series-title"
                                                        title="Sau khi được tôi an ủi, em gái đã không thể sống thiếu tôi được nữa">
                                                        <a href=""
                                                            class="link-underline link-underline-opacity-0 text-white">Sau
                                                            khi được tôi an ủi, em gái đã không thể sống thiếu tôi được
                                                            nữa</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="thumb-item-flow col-2 col-md-5 col-lg-3 type-original "
                                            id="tns1-item6" aria-hidden="true" tabindex="-1">
                                            <div class="thumb-wrapper">
                                                ...
                                                <div class="thumb-detail">
                                                    <div class="thumb_attr series-title"
                                                        title="Không biết bằng cách nào, dàn mỹ nhân hạng S lại đề cập đến tôi">
                                                        <a href=""
                                                            class="link-underline link-underline-opacity-0 text-white">Không
                                                            biết bằng cách nào, dàn mỹ nhân hạng S lại đề cập đến tôi</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="thumb-item-flow col-2 col-md-5 col-lg-3 type-original "
                                            id="tns1-item7" aria-hidden="true" tabindex="-1">
                                            <div class="thumb-wrapper">
                                                ...
                                                <div class="thumb-detail">
                                                    <div class="thumb_attr series-title" title="Goodbye, I Loved You.">
                                                        <a href=""
                                                            class="link-underline link-underline-opacity-0 text-white">Goodbye,
                                                            I Loved You.</a>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="tns-nav" aria-label="Carousel Pagination"><button type="button" data-nav="0"
                                    ...
                                    aria-controls="tns1" style="" aria-label="Carousel Page 2"></button><button
                                    type="button" data-nav="2" tabindex="-1" aria-controls="tns1"
                                    style="display:none" aria-label="Carousel Page 3"></button><button type="button"
                                    data-nav="3" tabindex="-1" aria-controls="tns1" style="display:none"
                                    aria-label="Carousel Page 4"></button><button type="button" data-nav="4"
                                    tabindex="-1" aria-controls="tns1" style="display:none"
                            ...
                            <article class="detail-list-item">
                                ...
                                <div class="detail-list-detail">
                                    ...
                                    <div class="series-summary">Có một cậu bé tên là Linky, cậu lao vào bóng đêm trong
                                        một tối nọ. Lúc nhận ra thì đã hàng thiên niên kỷ trôi qua rồi, mọi thứ xung
                            ...
                            <article class="detail-list-item">
                                ...
                                <div class="detail-list-detail">
                                    ...
                                    <div class="series-summary">Cùng phiêu lưu với Sokudo Kamaza, cậu bé với trái tim
                                        dũng cảm và đôi chân bùng nổ tốc độ! Sokudo không chỉ là một học sinh bình
                                        thường, cậu ấy còn là Velocity, chiến binh trong bộ giáp nano siêu ngầu, bảo vệ
                            ...
                            <article class="detail-list-item">
                                ...
                                <div class="detail-list-detail">
                                    ...
                                    <div class="series-summary">Từng bị bắt nạt thời tiểu học, Kamito Haku đã thoát khỏi
                                        số phận đen đủi khi lên cấp hai. Vì thế, cậu luôn trân trọng từng khoảnh khắc
                                        của cuộc đời. Nhưng trong một ngày, cả gia đình và người bạn thân nhất của Haku
                            ...
                            <article class="detail-list-item">
                                ...
                                <div class="detail-list-detail">
                                    ...
                                    <div class="series-summary">- Hi vọng, hi vọng thật mong manh nhưng các người lại
                                        quá tham vọng về nó. Nếu không có hi vọng thì làm sao có được ước mơ chứ !
                                        Những người Earth xuất hiện tại lục địa Vocaylas, một thế giới trong giấc mơ của
                            ...
                            <article class="detail-list-item">
                                ...
                                <div class="detail-list-detail">
                                    ...
                                    <div class="series-summary">Khi một mình từ Aomori chuyển đến Kyoto phồn hoa vào đầu
                                        năm thứ hai trung học, Senjougahara Rin thỉnh thoảng có cảm giác mình đã mơ một
                                        giấc rất dài. Dài và rõ ràng đến mức đôi khi cô phải tự hỏi, đó thật sự chỉ là
                            ...
                            <article class="detail-list-item">
                                ...
                                <div class="detail-list-detail">
                                    ...
                                    <div class="series-summary">Cái ngày anh ta ra đời, anh ta đã rất hạnh phúc với gia
                                        đình nhỏ gồm cha mẹ và em gái của mình. Nhưng hạnh phúc chưa được bao lâu, ngày
                                        anh ta lên bảy cha mẹ anh đã mất vì tai nạn nhưng đó chỉ là vở kịch che đậy sự
                            ...
                            <article class="detail-list-item">
                                ...
                                <div class="detail-list-detail">
                                    ...
                                    <div class="series-summary">Câu chuyện kể về một nam sinh lớp 10 bất ngờ nhận được
                                        ký ức từ tương lai của mình, kèm theo một yêu cầu lạ lùng về tình yêu.
                            ...
                            <article class="detail-list-item">
                                ...
                                <div class="detail-list-detail">
                                    ...
                                    <div class="series-summary">Làm thế nào để sống trong một thế giới không có mục
                                        đích?&nbsp;
                                        Giữa thế giới dần đến hồi diệt vong, con người tìm được ánh sáng qua những Thiên
                                ...
                                <div class="section-content">
                                    ...
                                    <div class="comment-item">
                                        ...
                                        <div class="comment-info">
                                            ...
                                            <div class="comment-content">
                                                Ngoài ra thì đây cũng là tên của một trong hai album nhạc mà mình lấy
                                    ...
                                    <ul class="others-list">
                                        <li>
                                            <div class="others-img no-padding">
                                                <div class="a6-ratio">
                                                    <div class="content img-in-ratio"
                                                        style="background-image: url('{{asset('users/user/img/avatar/ua26550-3cb8cabc-0f04-4538-949b-82bd1191c2a3.jpg')}}')">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="others-info">
                                                ...
                                                <small class="series-summary">Hãy đặt lời thề của ngươi trước các thánh
                                                    nhân, quỳ lạy trước những vị t...</small>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="others-img no-padding">
