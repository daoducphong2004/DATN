...
<script>
    ...
    document.getElementById('filterWeek').addEventListener('click', () => {
        ...
        endDate = endOfWeek;
        fetchRevenueData({{ $user->id }}, 'coin', startOfWeek, endOfWeek, book_id, 'line');

        fetchChapterRevenueData({{ $user->id }}, 'coin', startOfWeek, endOfWeek, book_id);
    });
    ...
    document.getElementById('filterMonth').addEventListener('click', () => {
        ...
        endDate = endOfMonth;
        fetchRevenueData({{ $user->id }}, 'coin', startOfMonth, endOfMonth, book_id, 'line');
        fetchChapterRevenueData({{ $user->id }}, 'coin', startOfMonth, endOfMonth, book_id);
    });
    ...
    document.getElementById('filterYear').addEventListener('click', () => {
        ...
        endDate = endOfYear;
        fetchRevenueData({{ $user->id }}, 'coin', startOfYear, endOfYear, book_id, 'bar');
        fetchChapterRevenueData({{ $user->id }}, 'coin', startOfYear, endOfYear, book_id);
    });

    document.getElementById('fetchData').addEventListener('click', () => {
        startDate = document.getElementById('startDate').value;
        endDate = document.getElementById('endDate').value;
        fetchRevenueData({{ $user->id }}, 'coin', startDate, endDate, book_id, 'line');
        fetchChapterRevenueData({{ $user->id }}, 'coin', startDate, endDate, book_id);
    });
...
`;
    ...
    const loadPage = (page) => {
        ...
        fetchChapterRevenueData({{ $user->id }}, 'coin', startDate, endDate, book_id, page);
    };
