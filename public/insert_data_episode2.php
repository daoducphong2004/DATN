...
if ($episodes_data) {
    ...
    foreach ($episodes_data as $episode) {
        ...
        $episode_path = 'episode_path/no-cover.jpg';
        ...
        // Insert query
        $sql = "INSERT INTO episodes (id, slug, title, episode_path, book_id, created_at, updated_at, user_id, `order`)
                VALUES ($id, '$slug', '$title',  '$episode_path', $book_id, '$created_at', '$updated_at', $user_id, $order)";
