...
if ($books_data) {
    ...
    foreach ($books_data as $book) {
        ...
        $sql = "INSERT INTO books (id, slug, title, author, painter, book_path, description, word_count, view, `like`, note, status, adult, type, group_id, created_at, updated_at, Is_Inspect, user_id)
                VALUES ($id, '$slug', '$title', '$author', '$painter', '$book_path', '$description', $word_count, $view, $like, '$note', $status, $adult, $type, $group_id, '$created_at', '$updated_at', $Is_Inspect, $user_id)";
