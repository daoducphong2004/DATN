                                ...
                                <script>
                                    tinymce.init({
                                        ...
                                        // plugins: 'wordcount link code fullscreen paste emoticons textcolor', // Thêm 'textcolor' để chỉnh màu chữ
                                        toolbar: 'undo redo | bold italic underline strikethrough forecolor | alignleft aligncenter alignright alignjustify | removeformat | fullscreen wordcount', // Thêm 'forecolor' để chỉnh màu
