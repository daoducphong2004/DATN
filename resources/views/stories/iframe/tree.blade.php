            ...
            @foreach ($book->episodes as $item)
                <li>
                    ...
                    <ul class="hide">
                        ...
                        <li>
                            <a class="li-link" href="{{ route('chapter.show',$chapter->id) }}" target="_blank"><i
                                    class="fas fa-external-link-alt"></i></a>
                            <span class="chapter-name level2" id="chapter_{{ $chapter->id }}" data-item="{{ $chapter->id }}">{{ $chapter->title }}</span>
                        </li>
                        @endforeach
